...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-vc63$t07zd2w6vhkvw(=+p$vro+jkk0p@u==p@b#dmag8r^#v0')
...
# GeoDjango needs to find GDAL — set explicitly for Docker slim images
